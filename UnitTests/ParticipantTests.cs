...
namespace UnitTests
{
    public class ParticipantTests
    {
        ...
        {
            var participant = new Participant(Guid.NewGuid(), 1, null, DateTimeOffset.Now);
        ...
        {
            var participant = new Participant(Guid.NewGuid(), 1, 2, DateTimeOffset.Now);
        ...
        {
            var participant = new Participant(Guid.NewGuid(), 1, 1, DateTimeOffset.Now);
            participant.ActualAttemptsCount.Should().Be(1);
